...
export function createSceneWithLandscape(scene) {
    ...
    function findVerticesInsideCube(
        intersectPoint,
        cubeSize,
        terrainVertices,
        divisions,
    ...
    function calculateTerrainVolumeInCube(
        intersectPoint,
        terrainVertices,
        size,
        divisions
    ...
    function onMouseClick(event) {
        ...
        if (intersects.length > 0) {
            ...
            const verticesInsideCube = findVerticesInsideCube(
                intersectPoint,
                32,
                terrainVertices,
                divisions,
            ...
            const volume = calculateTerrainVolumeInCube(
                intersectPoint,
                terrainVertices,
                size,
                divisions
